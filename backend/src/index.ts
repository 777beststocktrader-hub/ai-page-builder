...
function getBuiltInSharePage(id: string): string | null {
  ...
  const heroImage = 'https://cdn.shopify.com/s/files/1/0556/1650/4120/files/Scae4a76ed8f0440891ced53d8ef0c2c2C.webp?v=1779660000';
  return `<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
